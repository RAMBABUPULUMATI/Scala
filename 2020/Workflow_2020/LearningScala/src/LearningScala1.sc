object LearningScala1 {
  ...
  val hello: String = "Hola Shelly!"              //> hello  : String = Hola Shelly!
  println(hello)                                  //> Hola Shelly!
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Hola Shelly!
  helloThere = hello + " There!"
  println(helloThere)                             //> Hola Shelly! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Hola Shelly!There!
  println(immutableHelloThere)                    //> Hola Shelly!There!
